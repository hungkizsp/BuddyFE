  ...
  return (
    <div className="reward-popup-overlay">
      ...
      <div className="reward-card">
        ...
        <h2 className="reward-title">Nhiệm vụ hoàn thành!</h2>

        <div className="reward-items-container">
          {/* XP Pill */}
          <div className="reward-item-pill">
            <span className="reward-item-emoji">🌟</span>
            <span className="reward-item-value xp-color">+{xpReward} Kinh nghiệm</span>
          </div>

          {/* Coins Pill */}
          <div className="reward-item-pill">
            <span className="reward-item-emoji">🪙</span>
            <span className="reward-item-value coin-color">+{coinReward} Xu</span>
          </div>
        </div>
